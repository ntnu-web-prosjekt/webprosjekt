      ...
      <div id="statistics">
        ...
        <div id="statbox-container">
          <div className="statbox">
            ...
            <p className="statvalue">{this.state.openRequests != null ? this.state.openRequests : "X"}</p>
          </div>
          <div className="statbox">
            <p className="stattype">Matched requests</p>
            <p className="statvalue">{this.state.matchedRequests != null ? this.state.matchedRequests : "X"}</p>
          </div>
        </div>
      </div>
    );
